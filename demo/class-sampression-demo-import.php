...
if ( ! class_exists( 'Sampression_Demo_Import' ) ) {
	/**
	 * Main class
	 *
	 * @since 1.0.0
	 */
	class Sampression_Demo_Import {
		/**
		 * Singleton instance of Sampression_Demo_Import.
		 *
		 * @var Sampression_Demo_Import $instance Sampression_Demo_Import instance.
		 */
		...
		/**
		 * Main Sampression_Demo_Import instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Sampression_Demo_Import ) ) {
				self::$instance = new Sampression_Demo_Import();
